...
// // highlight selection{{{
// const highlight_sections = (selector) => {
//    doms(selector).forEach((dom) => {
//       observer_dom(dom, highlight_on, highlight_off);
//    });
// };
// const highlight_on = (d) => {
//    dom(`[href='#${d.id}']`).classList.add('active');
// };
// const highlight_off = (d) => {
//    doms('header a.active').forEach((dom) => dom.classList.remove('active'));
// };
// /*}}}*/
// // animate on focus{{{
// const animate_on_focus = (doms_string) => {
//    doms(doms_string).forEach((d) => {
//       observer_dom(
//          d,
//          (dom) => (dom.style.animationPlayState = 'running'),
//          (dom) => (dom.style.animationPlayState = 'paused')
//       );
//    });
// }; //
// /*}}}*/

// const scroll = (actions_down, actions_up) => {
//    window.addEventListener('scroll', function () {
//       update_scroll();
//       if (this.scrollY > this.position_old)
//          actions_down.forEach((action) => action());
//       else actions_up.forEach((action) => action());
//       this.position_old = this.scrollY;
//    });
// };

// window.onscroll = function () {
//    if (this.scrollY > this.position_old) {
//       dom('header').style.transform = 'translateY(-200px)';
//    } else {
//       dom('header').style.transform = 'translateY(0)';
//    }
//    this.position_old = this.scrollY;
...
//       const position_scroll = window.scrollY + window.innerHeight;
//       if (position_dom < position_scroll) {
//          list[key]();
//          window[key] = true;
//       }
//    }
...
// const update_scrolling_on = (selector) => {
//    observer_dom(
//       dom(selector),
//       () => {
...
// highlight_sections('section');
// update_scrolling_on('body');
// update_scrolling_on('#contact');
...
window.onload = () => {
   dom('.preloader').className += ' disappear';
